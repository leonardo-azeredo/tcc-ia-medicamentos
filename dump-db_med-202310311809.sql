...
CREATE TABLE `paciente_enfermidade` (
  ...
  KEY `id_enfermidade` (`id_enfermidade`),
  CONSTRAINT `paciente_enfermidade_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `paciente` (`id_paciente`),
  CONSTRAINT `paciente_enfermidade_ibfk_2` FOREIGN KEY (`id_enfermidade`) REFERENCES `enfermidade` (`id_enfermidade`)
...
CREATE TABLE `paciente_medicamento` (
  ...
  CONSTRAINT `paciente_medicamento_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `paciente` (`id_paciente`),
  CONSTRAINT `paciente_medicamento_ibfk_2` FOREIGN KEY (`id_medicamento`) REFERENCES `medicamento` (`id_medicamento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (4,'Leonardo Azeredo Pereira','leonardoazeredosjc@gmail.com','c7e366236dc3b9ec0d8a0a60bc5e9910');
...
-- Dump completed on 2023-10-31 18:09:41
